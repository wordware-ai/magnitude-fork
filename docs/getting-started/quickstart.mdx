...
<Steps>
  ...
  <Step title="Configure LLM">
    The easiest way to set up an LLM for Magnitude is to set the `ANTHROPIC_API_KEY` environment variable. Sonnet 4 will be used by default. See [Compatible LLMS](/customizing/compatible-llms) for more details.
  </Step>
</Steps>
