...
But yikes! That password doesn't look secure. For sensitive information, use `secureData` instead.
...
This will ensure that the secure data fields are encrypted end-to-end on Magnitude's servers.
