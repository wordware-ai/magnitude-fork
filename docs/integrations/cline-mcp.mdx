---
title: 'Cline MCP'
description: 'Enable Cline to build and run Magnitude tests with MCP'
---
...
3. Get API key at https://app.magnitude.run/signup and make accessible as `MAGNITUDE_API_KEY` environment variable (e.g. by adding to `~/.bashrc`/`~/.zshrc`)
