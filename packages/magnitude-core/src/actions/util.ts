    ...
    private _parseObject(jsonSchema: JsonSchema): FieldType {
        ...
        if (properties && typeof properties === 'object') {
            for (const [fieldName, fieldSchemaUntyped] of Object.entries(properties)) {
                ...
                const fieldSchema = fieldSchemaUntyped as JsonSchema; // This is the schema for the *field*
                ...
                // Python script DOES set description on ClassPropertyBuilder (property_)
                // from the field's schema description.
                let fieldDescription = fieldSchema.description; // Description for the specific field
...
function convertJsonSchemaToBaml(tb: TypeBuilder, jsonSchema: any): FieldType {
